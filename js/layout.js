const commonHeader = `
  <div class="page-loader" aria-hidden="true">
    <img class="page-loader__fallback" src="assets/logo/logo_atlas_loader.svg" alt="">
  </div>

  <header class="site-header">
    <a class="site-header__brand" href="index.html" aria-label="Atlas Contabilidade Digital - pagina inicial">
      <img src="assets/logo/logo_atlas_loader.svg" alt="Logo da Atlas Contabilidade Digital">
    </a>
    ...
    <div class="site-header__social">
      <a href="https://www.instagram.com/atlascontabilidade/" target="_blank" rel="noopener" aria-label="Instagram da Atlas">
      ...
      <a href="https://www.facebook.com/contabilidadeatlas/?locale=pt_BR" target="_blank" rel="noopener" aria-label="Facebook da Atlas">
      ...
      <a href="https://api.whatsapp.com/send/?phone=5548984040777&text&type=phone_number&app_absent=0" target="_blank" rel="noopener" aria-label="WhatsApp da Atlas">
  ...
  <section class="contact-section" id="contato" aria-labelledby="contact-title">
    <div class="contact-section__layout">
      <div class="contact-section__content">
        ...
        <a class="contact-section__cta" href="https://wa.me/5548984040777?text=Ol%C3%A1%2C%20gostaria%20de%20saber%20mais%20sobre%20os%20servi%C3%A7os%20da%20Atlas%20Contabilidade%20Digital." target="_blank" rel="noopener" aria-label="Falar com especialista no WhatsApp">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            <path d="M12.04 4.2a7.72 7.72 0 0 0-6.55 11.8l.2.31-.72 2.66 2.72-.71.3.18a7.73 7.73 0 1 0 4.05-14.24Zm0 13.97a6.23 6.23 0 0 1-3.17-.86l-.44-.26-1.43.38.38-1.39-.29-.45a6.22 6.22 0 1 1 4.95 2.58Zm3.42-4.64c-.19-.1-1.1-.54-1.27-.6-.17-.07-.29-.1-.42.09-.12.19-.48.6-.59.72-.11.13-.22.14-.41.05-.19-.1-.8-.29-1.53-.93a5.7 5.7 0 0 1-1.06-1.32c-.11-.19-.01-.29.08-.39.08-.08.19-.22.28-.32.09-.11.12-.19.19-.32.06-.13.03-.24-.02-.34-.05-.09-.42-1-.57-1.38-.15-.36-.3-.31-.42-.32h-.35c-.13 0-.34.05-.51.24-.17.19-.67.65-.67 1.59s.69 1.84.78 1.97c.1.13 1.35 2.06 3.27 2.89.46.2.81.32 1.09.41.46.14.88.12 1.21.07.37-.05 1.1-.45 1.26-.88.15-.43.15-.8.11-.88-.05-.08-.17-.13-.36-.22Z"/>
          </svg>
    ...
    <div class="site-footer__inner">
      ...
      <div class="site-footer__actions">
        <div class="site-footer__social" aria-label="Redes sociais da Atlas">
          <a class="site-footer__social-link" href="https://www.instagram.com/atlascontabilidade/" target="_blank" rel="noopener" aria-label="Instagram da Atlas">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          <a class="site-footer__social-link" href="https://api.whatsapp.com/send/?phone=5548984040777&text&type=phone_number&app_absent=0" target="_blank" rel="noopener" aria-label="WhatsApp da Atlas">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M12.04 4.2a7.72 7.72 0 0 0-6.55 11.8l.2.31-.72 2.66 2.72-.71.3.18a7.73 7.73 0 1 0 4.05-14.24Zm0 13.97a6.23 6.23 0 0 1-3.17-.86l-.44-.26-1.43.38.38-1.39-.29-.45a6.22 6.22 0 1 1 4.95 2.58Zm3.42-4.64c-.19-.1-1.1-.54-1.27-.6-.17-.07-.29-.1-.42.09-.12.19-.48.6-.59.72-.11.13-.22.14-.41.05-.19-.1-.8-.29-1.53-.93a5.7 5.7 0 0 1-1.06-1.32c-.11-.19-.01-.29.08-.39.08-.08.19-.22.28-.32.09-.11.12-.19.19-.32.06-.13.03-.24-.02-.34-.05-.09-.42-1-.57-1.38-.15-.36-.3-.31-.42-.32h-.35c-.13 0-.34.05-.51.24-.17.19-.67.65-.67 1.59s.69 1.84.78 1.97c.1.13 1.35 2.06 3.27 2.89.46.2.81.32 1.09.41.46.14.88.12 1.21.07.37-.05 1.1-.45 1.26-.88.15-.43.15-.8.11-.88-.05-.08-.17-.13-.36-.22Z"/>
            </svg>
          </a>
          <a class="site-footer__social-link" href="https://www.facebook.com/contabilidadeatlas/?locale=pt_BR" target="_blank" rel="noopener" aria-label="Facebook da Atlas">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M14 8.4V6.8c0-.72.48-.9.82-.9H17V2.1L14 2c-3.34 0-4.1 2.5-4.1 4.1v2.3H7v3.9h2.9V22H14v-9.7h3.1l.42-3.9H14Z"/>
            </svg>
          </a>
          <a class="site-footer__social-link" href="mailto:contato@atlascontabilidade.com.br" target="_blank" rel="noopener" aria-label="Enviar e-mail para a Atlas">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
